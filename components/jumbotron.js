  ...
  return (
    <div className="bg-seaGreen p-10">
      ...
      <p className="text-white my-4">
        ...
        This webpage gives me a way of reflecting on what I've learned each day,
        while seeing my own growth through daily Python projects.
      </p>
      <div className="text-white leading-20">
        <a
          href="https://www.sarastrasner.com/"
          rel="noreferrer"
          target="_blank"
        >
          <button className="bg-brightGreen p-2 rounded text-white">
            Learn more about me!
          </button>
        </a>
      </div>
